...
GRPCInferenceService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_ModelStatistics_(GRPCInferenceService_method_names[6], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_SystemSharedMemoryStatus_(GRPCInferenceService_method_names[7], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_SystemSharedMemoryRegister_(GRPCInferenceService_method_names[8], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_SystemSharedMemoryUnregister_(GRPCInferenceService_method_names[9], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_CudaSharedMemoryStatus_(GRPCInferenceService_method_names[10], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_CudaSharedMemoryRegister_(GRPCInferenceService_method_names[11], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_CudaSharedMemoryUnregister_(GRPCInferenceService_method_names[12], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ModelInfer_(GRPCInferenceService_method_names[13], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ModelStreamInfer_(GRPCInferenceService_method_names[14], options.suffix_for_stats(),::grpc::internal::RpcMethod::BIDI_STREAMING, channel)
  {}
...
::grpc::ClientReaderWriter< ::inference::ModelStreamInferRequest, ::inference::ModelStreamInferResponse>* GRPCInferenceService::Stub::ModelStreamInferRaw(::grpc::ClientContext* context) {
  return ::grpc::internal::ClientReaderWriterFactory< ::inference::ModelStreamInferRequest, ::inference::ModelStreamInferResponse>::Create(channel_.get(), rpcmethod_ModelStreamInfer_, context);
}

void GRPCInferenceService::Stub::async::ModelStreamInfer(::grpc::ClientContext* context, ::grpc::ClientBidiReactor< ::inference::ModelStreamInferRequest,::inference::ModelStreamInferResponse>* reactor) {
  ::grpc::internal::ClientCallbackReaderWriterFactory< ::inference::ModelStreamInferRequest,::inference::ModelStreamInferResponse>::Create(stub_->channel_.get(), stub_->rpcmethod_ModelStreamInfer_, context, reactor);
}

::grpc::ClientAsyncReaderWriter< ::inference::ModelStreamInferRequest, ::inference::ModelStreamInferResponse>* GRPCInferenceService::Stub::AsyncModelStreamInferRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc::internal::ClientAsyncReaderWriterFactory< ::inference::ModelStreamInferRequest, ::inference::ModelStreamInferResponse>::Create(channel_.get(), cq, rpcmethod_ModelStreamInfer_, context, true, tag);
}

::grpc::ClientAsyncReaderWriter< ::inference::ModelStreamInferRequest, ::inference::ModelStreamInferResponse>* GRPCInferenceService::Stub::PrepareAsyncModelStreamInferRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncReaderWriterFactory< ::inference::ModelStreamInferRequest, ::inference::ModelStreamInferResponse>::Create(channel_.get(), cq, rpcmethod_ModelStreamInfer_, context, false, nullptr);
}
...
GRPCInferenceService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::BidiStreamingHandler< GRPCInferenceService::Service, ::inference::ModelStreamInferRequest, ::inference::ModelStreamInferResponse>(
          [](GRPCInferenceService::Service* service,
             ::grpc::ServerContext* ctx,
             ::grpc::ServerReaderWriter<::inference::ModelStreamInferResponse,
             ::inference::ModelStreamInferRequest>* stream) {
...
::grpc::Status GRPCInferenceService::Service::ModelStreamInfer(::grpc::ServerContext* context, ::grpc::ServerReaderWriter< ::inference::ModelStreamInferResponse, ::inference::ModelStreamInferRequest>* stream) {
  (void) context;
  (void) stream;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
}
