...
echo ""
echo "2️⃣  2개 비디오 동시:"
echo "   • 개별 FPS: ~$FPS1, ~$FPS2"
TOTAL_2=$(python3 -c "print(f'{1800 / $TOTAL_TIME:.2f}')") 2>/dev/null || TOTAL_2="계산 실패"
...
echo ""
echo "3️⃣  4개 비디오 동시:"
echo "   • 개별 FPS: ~$FPS1, ~$FPS2, ~$FPS3, ~$FPS4"
TOTAL_4=$(python3 -c "print(f'{3600 / $TOTAL_TIME:.2f}')") 2>/dev/null || TOTAL_4="계산 실패"
